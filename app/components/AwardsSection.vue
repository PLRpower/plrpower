  ...
  <section id="awards" class="relative mt-48 md:mt-64 px-6 md:px-10 overflow-hidden" @mousemove="updateHoverPos">
    ...
    <div class="max-w-[1200px] mx-auto relative z-10">
      <div class="flex items-center gap-4 mb-6">
        <span class="font-handwriting text-2xl text-accent/80">Awards</span>
      ...
      <div class="flex flex-col border-t border-white/[0.05] light:border-black/[0.05] award-item">
        <div v-for="award in awardsData" :key="award.title" 
          ...
          <div class="flex flex-col md:flex-row md:items-center gap-2 md:gap-12 w-full">
      ...
      <ClientOnly>
        <Teleport to="body">
          <div v-if="activeAward" 
               ref="awardCursorRef"
               class="fixed pointer-events-none z-50 overflow-hidden rounded-2xl border border-white/10 light:border-black/10 bg-[#080808]/95 light:bg-white/95 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] light:shadow-[0_20px_50px_rgba(0,0,0,0.1)] items-center gap-5 p-5 w-[340px] hidden md:flex"
            ...
            <div class="w-16 h-16 shrink-0 bg-white/5 light:bg-black/5 rounded-xl flex items-center justify-center border border-white/5 light:border-black/5">
